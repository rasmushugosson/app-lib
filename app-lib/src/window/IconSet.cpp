...
ae::IconSetContainer::IconSetContainer() = default;
...
ae::IconSet::IconSet() : m_pContainer(nullptr) {}

ae::IconSet::IconSet(const std::initializer_list<std::string> &paths) : m_pContainer(nullptr)
{
...
ae::IconSet::IconSet(const IconSet &icon) = default;

ae::IconSet::~IconSet() = default;

ae::IconSet &ae::IconSet::operator=(const IconSet &icon) = default;
